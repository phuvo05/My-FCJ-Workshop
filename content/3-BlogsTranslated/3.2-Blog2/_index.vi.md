...
Giải pháp mất khoảng 30–45 phút để thiết lập. Chi phí thay đổi dựa trên khối lượng dữ liệu và tần suất truy vấn. Sử dụng [<u>Công cụ tính giá AWS</u>](https://calculator.aws/#/) để biết các ước tính cụ thể.
